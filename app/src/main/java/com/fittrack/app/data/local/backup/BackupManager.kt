package com.fittrack.app.data.local.backup
...
import com.fittrack.app.data.local.database.entity.*
...
class BackupManager(
    ...
    suspend fun importBackup(uri: Uri): Result<Unit> {
        return try {
            ...
            val backup = json.decodeFromString<FitTrackBackup>(backupText)
